...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	for(MNovelVO mNovelVO:list){
		...
		jsonTemp.put("num_novel", mNovelVO.getNovelNum());
		jsonTemp.put("likes", mNovelVO.getLikeCnt());
		jsonTemp.put("num_report", mNovelVO.getReportCnt()); 
		jsonTemp.put("make", sdf.format(mNovelVO.getCreateDate()));
